...
import { getMyAdverts, getMyData, updateUser, updatePassword, baseUrl, addAvatar } from '../../api/api';
    ...
    return (
        <S.Page>
            ...
            <S.Profile>
                <S.ProfilePhoto>
                    <S.Photo
                        src={user.avatar ? baseUrl + user.avatar : '/img/notImage.png'}
                    ></S.Photo>
                    <label>
                        Заменить
                        <S.ChangePhoto
                ...
                <S.ProfileData>
                    ...
                    <S.InputBoxPassword>
                        <S.InputName>Новый пароль</S.InputName>
                        <S.Input
                            type="password"
                            value={newPassword}
                    ...
                    <S.SaveButton onClick={handleUpdate} disabled={activeButton}>
                        Сохранить
                    </S.SaveButton>
                </S.ProfileData>
            </S.Profile>
